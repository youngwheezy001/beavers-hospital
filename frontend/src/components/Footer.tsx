      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-center md:justify-start gap-4">
            {/* WhatsApp */}
            <a href="https://wa.me/254769010009" target="_blank" className="bg-green-500/10 p-3 rounded-2xl text-green-500 hover:bg-green-500 hover:text-white transition-all shadow-lg shadow-green-500/10">
